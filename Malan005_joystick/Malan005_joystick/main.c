 ...
 */ 
 ...
 {
	//changed the pins; my setup was different that the websites set up. 
	 ...
	 DDRA = 0x00; PORTA = 0xFF;//Taking portA as input.

	 

	 int HORIZONTAL = 512;//neutral value on x-axis
						  //changed this value from the original code
...

	 {
		 ...
		 if (HORIZONTALMOV > HORIZONTAL+ 500) //changed this value from the original code 
		 ...
		 if (HORIZONTALMOV < (HORIZONTAL)) //changed this value from the original code 
		 ...
		 if (VERTICAlMOV<VERTICAl ) //changed this value from the original code 
		 ...
		 if (VERTICAlMOV >VERTICAl + 300) //changed this value from the originial code //orginal value 500
